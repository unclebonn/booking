...
export default function PopupScreenInformation({ isPopup, setPopup }: { isPopup?: boolean, setPopup?: any }) {
        ...
        form
            ...
            .then((values) => {
                ...
                updateInformation(values)
                    .then((res) => {
                        if (res.status == 200) {
                            cookies.set("token", { ...cookies.get("token"), information: res.data.loginCustomer }, { path: "/", maxAge: 7200 }) // ve nha sua cai nay
    ...
    const updateInformation = (values: any) => {
        const api_link =  api_links.user.customer.updateInformation 
    ...
    return (
        ...
        >
            <Form
                form={form}
            >
                <Space direction="horizontal" align="center" style={{ width: "100%", justifyContent: "space-around" }}>
                    <Space>
                        <Form.Item
                            name="avatar"
                        >
